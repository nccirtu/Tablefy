// lib/table/columns/number-column.tsx
...
export class NumberColumn<TData> extends BaseColumn<TData, NumberColumnConfig<TData>> {
    ...
    build(): ColumnDef<TData, unknown> {
        ...
        return {
            ...
            cell: ({ getValue }) => {
                ...
                return <span className={cn('tabular-nums', this.getAlignmentClass(), this.config.cellClassName)}>{displayValue}</span>;
            },
        };
    }
}
