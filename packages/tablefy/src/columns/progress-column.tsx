...
export class ProgressColumn<TData> extends BaseColumn<
  TData,
  ProgressColumnConfig<TData>
> {
      ...
      cell: ({ getValue }) => {
        ...
        return (
          ...
          >
            ...
            />
            {labelText && (
              <span className="text-muted-foreground min-w-[3rem] text-right text-sm tabular-nums">
                {labelText}
              </span>
            )}
          </div>
