...
// Alle UI-Primitives sind ins Package gebundelt – der User muss KEINE shadcn-
// Komponenten mehr installieren. Liste bewusst leer (der init-Befehl überspringt
// den shadcn-Schritt damit automatisch).
export const SHADCN_COMPONENTS: readonly string[] = [];
